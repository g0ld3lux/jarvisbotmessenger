...
@section('content')
    <div ng-controller="RespondsController">
        <div class="content-header">
            <div class="container">
                <div class="clearfix">
                    <div class="pull-left content-header-title"><a href="{{ route('bots.show', $bot->id) }}">{{ $bot->title }}</a> &raquo; Responds</div>
                                        ...
                                        <ul class="responds-list list-unstyled">
                                            <li class="col-md-4" ng-repeat="respond in responds | filter : search as filtered_responds track by respond.id">
                                                <div class="panel panel-default respond-item">
                                                    ...
                                                    <div class="clearfix">
                                                        <small class="date pull-right" bot-time time="respond.updated_at"></small>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
