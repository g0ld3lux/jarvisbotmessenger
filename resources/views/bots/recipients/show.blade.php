...
@section('content')
    <div ng-controller="RecipientController">
        <div class="content-header">
            <div class="container">
                <div class="clearfix">
                    <div class="pull-left content-header-title"><a href="{{ route('bots.show', $bot->id) }}">{{ $bot->title }}</a> &raquo; <a href="{{ route('bots.recipients.index', $bot->id) }}">Recipients</a> &raquo; @if($recipient->getPhotoUrl('recipient_small')) <img class="img-circle" src="{{ $recipient->getPhotoUrl('recipient_small') }}"> @endif {{ $recipient->display_name }}</div>
                            ...
                            <div class="panel-body">
                                <div class="clearfix">
                                    <div class="pull-right" ng-if="recipient.id">
                                        ...
                                        <a href="{{ route('bots.recipients.edit', [$bot->id, $recipient->id]) }}" class="btn btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil fa-btn"></i>Edit</a>
...
@push('ngTemplates')
    @include('bots.recipients._partials.add_channel_modal')
@endpush