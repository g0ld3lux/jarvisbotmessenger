            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <p class="form-control-static">
                        ...
                        <span ng-show="message.scheduled_at" bot-time time="message.scheduled_at"></span>
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <p class="form-control-static">
                        ...
                        <span ng-show="message.finished_at" bot-time time="message.finished_at"></span>
                    </p>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <p class="form-control-static">
                        ...
                        <span ng-show="message.created_at" bot-time time="message.created_at"></span>
                    </p>
                </div>
            </div>
            <div class="form-group">
