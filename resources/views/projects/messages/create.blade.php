...
@section('content')
    <div class="content-header">
        <div class="container">
            <div class="clearfix">
                <div class="pull-left content-header-title"><a href="{{ route('projects.show', $project->id) }}">{{ $project->title }}</a> &raquo; <a href="{{ route('projects.messages.index', $project->id) }}">Mass messages</a> &raquo; Schedule message</div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('projects.messages.store', $project->id) }}">
                            {!! csrf_field() !!}
    ...
    <script type="text/javascript">
        $(document).on("ready", function () {
            $("#select-schedule-time").datetimepicker({
                minDate: moment().tz("{{ $project->timezone }}")
            });
        });
    </script>
@endpush