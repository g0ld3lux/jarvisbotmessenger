...
@section('content')
    <div class="content-header">
        <div class="container">
            <div class="clearfix">
                <div class="pull-left content-header-title"><a href="{{ route('admin.packages.index') }}">Packages</a> &raquo; Edit Package</div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="box-body">
          <form method="POST" action="{{ route('admin.packages.update', $package->id) }}" accept-charset="UTF-8" class="form-horizontal" id="validate">
          {!! csrf_field() !!}
          {!! method_field('PATCH') !!}
                  ...
                  <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              ...
                              <input class="form-control validate[required]" placeholder="Package Name" name="name" type="text" id="name" value="{{ (old('name')) ? old('name') : $package->name }}">
                  ...
                  <div class="form-group{{ $errors->has('cost') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              ...
                              <input class="form-control validate[required,custom[number],min[0]]" placeholder="Amount: 100.00" step="0.01" name="cost" type="number" id="cost" value="{{ (old('cost')) ? old('cost') : $package->cost }}">
                          </div>
                          @if ($errors->has('cost'))
                              <span class="help-block">
                  ...
                  <div class="form-group{{ $errors->has('currency_code') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                          <div class="input-group">
                              ...
                              <input class="form-control validate[required]" placeholder="USD" name="currency_code" type="text" id="currency_code" value="{{ (old('currency_code')) ? old('currency_code') : $package->currency_code }}">
                  ...
                  <div class="form-group{{ $errors->has('per') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input class="form-control validate[required]" placeholder="month / year / lifetime" name="per" type="text" id="per" value="{{ (old('per')) ? old('per') : $package->per }}">
                  ...
                  <div class="form-group{{ $errors->has('plan') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input class="form-control validate[required]" placeholder="Subscription Plan ID" name="plan" type="text" id="plan" value="{{ (old('plan')) ? old('plan') : $package->plan }}">
                        </div>
                          @if ($errors->has('plan'))
                              <span class="help-block">
                  ...
                  <div class="form-group{{ $errors->has('order') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input class="form-control validate[required,custom[integer],min[1]]" placeholder="Set Chronological Order" name="order" type="number" id="order" value="{{ (old('order')) ? old('order') : $package->order }}">
                        </div>
                          @if ($errors->has('order'))
                              <span class="help-block">
                        ...
                        @endif
                          <div class="col-md-12">
                              <div class="input-group">
                                  ...
                                  <input class="form-control validate[required]" placeholder="Describe This Feature For this Package" name="feature_description[{{ $id }}]" type="text" id="feature_description{{ $id }}"
