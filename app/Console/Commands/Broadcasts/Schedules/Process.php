...
namespace App\Console\Commands\Broadcasts\Schedules;

use App\Jobs\Subscription\Channel\Broadcast\ProcessScheduleJob;
...
class Process extends Command
{
     ...
     * @var string
     */
    protected $name = 'broadcasts:schedules:process';
     ...
     * @var string
     */
    protected $description = 'Process scheduled broadcasts.';
