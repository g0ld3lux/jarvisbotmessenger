...
Now, let's see the actual code of this class::
    ...
    class Bot_Set_TokenParser extends Twig_TokenParser
    {
        public function parse(Twig_Token $token)
        {
            ...
            return new Bot_Set_Node($name, $value, $token->getLine(), $this->getTag());
        }
...
method::
    ...
    class Bot_Twig_Extension extends Twig_Extension implements Twig_Extension_GlobalsInterface
    {
...
(runtime classes must be autoload-able)::
    ...
    class RuntimeLoader implements Twig_RuntimeLoaderInterface
    {
        public function load($class)
        {
            ...
            if ('Bot_Twig_RuntimeExtension' === $class) {
...
``Bot_Twig_RuntimeExtension`` class and use it directly in the extension::

    class Bot_Twig_RuntimeExtension extends Twig_Extension
    {
        private $rot13Provider;
    ...
    class Bot_Twig_Extension extends Twig_Extension
    {
        ...
        {
            return array(
                new Twig_SimpleFunction('rot13', array('Bot_Twig_RuntimeExtension', 'rot13')),
                // or
                new Twig_SimpleFunction('rot13', 'Bot_Twig_RuntimeExtension::rot13'),
            );
        }
    }
